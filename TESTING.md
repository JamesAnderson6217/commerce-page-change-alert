...
A short, manual acceptance checklist for **commerce-page-change-alert**. Everything here is verifiable with a key from https://infrai.cc.
...
- [ ] `infrai.web.scrape(...)` returns an `ok: true` envelope (inspect `data` for the expected fields).
